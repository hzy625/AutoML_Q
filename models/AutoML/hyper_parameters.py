...
#Train files
TRAIN_FILE = './lmdb_folder/AutoML/train.lmdb'                                # Path to training lmdb file -- YOU NEED TO CHANGE THIS
VAL_FILE = './lmdb_folder/AutoML/val.lmdb'                                    # Path to validation lmdb file -- YOU NEED TO CHANGE THIS

CAFFE_ROOT = '/opt/caffe/'                                # Path to caffe root directory -- YOU NEED TO CHANGE THIS
